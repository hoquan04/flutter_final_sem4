...
// import 'package:grocery_flutter/model/grocery_compleated_model.dart';
...
class _GroceryOrderHistoryScreenState extends State<GroceryOrderHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //         ),
    //         body: TabBarView(
    //           children: <Widget>[compleated, PurchaseMoreScreen(), PurchaseMoreScreen()],
    //         ),
    //       ),
    //     ),
    //   ),
