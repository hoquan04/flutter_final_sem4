...
class _GroceryTermConditionState extends State<GroceryTermCondition> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //         Text(grocery_lbl_Long_text, style: secondaryTextStyle(color: grocery_textColorPrimary, size: 16)).paddingOnly(top: spacing_standard_new, left: spacing_standard_new, right: spacing_standard_new),
      ...
      //         Text("THESE TERMS AND CONDITIONS DO NOT AFFECT YOUR STATUTORY RIGHTS", style: boldTextStyle(color: grocery_textColorPrimary, size: 16)).paddingOnly(top: spacing_standard_new, left: spacing_standard_new, right: spacing_standard_new),
      //         SizedBox(height: spacing_standard_new),
      //         Text(
      //           "2. Amendments",
      //           style: boldTextStyle(color: grocery_textColorPrimary, size: 16),
