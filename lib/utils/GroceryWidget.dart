  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: text(widget.textContent, textColor: widget.isStroked ? grocery_colorPrimary : grocery_color_white, fontSize: textSizeLargeMedium, isCentered: true, fontFamily: fontSemiBold, textAllCaps: true),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(16, 6, 16, 6),
        alignment: Alignment.center,
        child: text(widget.textContent, textColor: widget.isStroked ? grocery_textGreenColor : grocery_textGreenColor, fontSize: textSizeLargeMedium, isCentered: true, fontFamily: fontSemiBold, textAllCaps: false),
